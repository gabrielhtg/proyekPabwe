...
{{--            tampilan desktop--}}
            <a class="d-none d-sm-flex align-items-center navbar-brand" href="/">
                <img src="{{ asset("/assets/img/Logo Institut Teknologi Del.png") }}" alt="Logo" width="45" height="45" class="d-inline-block align-text-top">
                <div class="ms-3 lh-1">
                    <span><strong>SPMB Institut Teknologi Del</strong></span>
                    <br>
                    <span class="fs-7"><i>MarTuhan, MarRoha, MarBisuk</i></span>
                </div>
            </a>
{{--            tampilan desktop end--}}
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto me-3">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" aria-current="page" href="#">Admisi</a>
                        <ul class="dropdown-menu">
